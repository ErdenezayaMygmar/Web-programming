...
(function() {
   ...
   // Create init users.
   var gan={_id:"216512318qe156489711006",first_name:"Gnbt",last_name:"Arnzy",
               location:"Mongolia UB",description:"My name is Ganbat",occupation:"GanbtArnzy"};
   ...
   var users = [gan,im, er, pt, rk, al, jo];
